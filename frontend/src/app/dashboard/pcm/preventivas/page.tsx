export default function PreventivasPage() {
    return (
        <div className="p-6 bg-surface border border-border-color rounded-xl h-[80vh] flex items-center justify-center flex-col text-center">
            <h2 className="text-2xl font-bold text-white mb-2">Programação de Preventivas</h2>
            <p className="text-gray-400">Atualização de Horímetro e Planos de Manutenção</p>
